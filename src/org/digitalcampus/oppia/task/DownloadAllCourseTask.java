...
public class DownloadAllCourseTask extends AsyncTask<Payload, DownloadProgress, Payload>{

	public final static String TAG = DownloadAllCourseTask.class.getSimpleName();
	...
	public DownloadAllCourseTask(Context ctx) {
		this.ctx = ctx;
