...
public class DiagnosticToolActivity extends BaseActivity implements
		OnItemClickListener {
...
//	private Context mContext;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * String[] category={"Breast Problems",
		 * "Complication Readiness & Newborn Danger Signs",
		 ...
		 * "Malaria Prevention"}; // String[] categoryDetails={
		 * "Importance of Exclusive Breastfeeding, Breast Attachement"};
		 * DiagnosticToolBaseAdapter adapter=new
		 * DiagnosticToolBaseAdapter(mContext,category);
		 * listView_diagnosticMenu.setAdapter(adapter);
		 */
		String[] encounter_location = { "Home Visit", "Outreach Clinic",
				"CHPS facility", "Health Center", "Hospital" };
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(mContext,
				android.R.layout.simple_list_item_1, encounter_location);
