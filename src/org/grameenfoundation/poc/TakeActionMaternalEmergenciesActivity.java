...
public class TakeActionMaternalEmergenciesActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setSubtitle("PNC Diagnostic: Maternal Emergencies > Difficulty Breathing");
	    json=new JSONObject();
	    try {
            ...
            getActionBar().setSubtitle("PNC Diagnostic: Maternal Emergencies > Shock");
    	    json=new JSONObject();
    	    try {
             ...
             getActionBar().setSubtitle("PNC Diagnostic: Maternal Emergencies > Heavy Bleeding");
     	    json=new JSONObject();
     	    try {
                 ...
                 getActionBar().setSubtitle("PNC Diagnostic: Maternal Emergencies > Convulsion");
          	    json=new JSONObject();
          	    try {
